...
<body>
	...
	<div class="main">
		...
		<form method="post" id="myform" onsubmit="return check()">
				...
				<table class="box">
					<tr>
						...
						<td><input type="text" name="id" id="id" class="text"
							...
							color="red">*</font><span id="iderror"></span>
						</td>
					...
					<tr>
						...
						<td><input type="text" name="age" class="text" id="age"
							...
							<font color="red">*</font><span id="ageerror"></span>
						</td>
					</tr>
					<tr>
						...
						<td><input type="text" name="phone" class="text" id="phone"
							...
							<font color="red">*</font><span id="phoneerror"></span>
						</td>
					...
					<tr>
						...
						<td><textarea name="address" id="address" class="text"
								cols="45" rows="5" disabled="disabled">${user.address}</textarea>
						</td>
					</tr>
					<tr>
			...
			<div class="buttons">
				<a href="userAdmin2.jsp" class="input-button">返回</a> 
				<a href="user_revise2.jsp" class="input-button">修改</a>
				<a href="user_changepassword.jsp?row=${user.id}"
					class="input-button">修改密码</a>
			</div>
		</form>
	</div>
